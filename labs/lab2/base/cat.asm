...
00000090 <cat>:
{
  ...
  printf(1, "printing in kernel");
  98:	83 ec 08             	sub    $0x8,%esp
  9b:	68 d8 07 00 00       	push   $0x7d8
  a0:	6a 01                	push   $0x1
  a2:	e8 09 04 00 00       	call   4b0 <printf>
  while((n = read(fd, buf, sizeof(buf))) > 0) {
  a7:	83 c4 10             	add    $0x10,%esp
  aa:	eb 1b                	jmp    c7 <cat+0x37>
  ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if (write(1, buf, n) != n) {
  b0:	83 ec 04             	sub    $0x4,%esp
  b3:	53                   	push   %ebx
  b4:	68 60 0b 00 00       	push   $0xb60
  b9:	6a 01                	push   $0x1
  bb:	e8 c3 02 00 00       	call   383 <write>
  c0:	83 c4 10             	add    $0x10,%esp
  c3:	39 d8                	cmp    %ebx,%eax
  c5:	75 25                	jne    ec <cat+0x5c>
  while((n = read(fd, buf, sizeof(buf))) > 0) {
  c7:	83 ec 04             	sub    $0x4,%esp
  ca:	68 00 02 00 00       	push   $0x200
  cf:	68 60 0b 00 00       	push   $0xb60
  d4:	56                   	push   %esi
  d5:	e8 a1 02 00 00       	call   37b <read>
  da:	83 c4 10             	add    $0x10,%esp
  dd:	89 c3                	mov    %eax,%ebx
  df:	85 c0                	test   %eax,%eax
  e1:	7f cd                	jg     b0 <cat+0x20>
  if(n < 0){
  e3:	75 1b                	jne    100 <cat+0x70>
}
  ...
  ef:	68 eb 07 00 00       	push   $0x7eb
  f4:	6a 01                	push   $0x1
  f6:	e8 b5 03 00 00       	call   4b0 <printf>
      exit();
  fb:	e8 63 02 00 00       	call   363 <exit>
    printf(1, "cat: read error\n");
 100:	50                   	push   %eax
 101:	50                   	push   %eax
 102:	68 fd 07 00 00       	push   $0x7fd
 107:	6a 01                	push   $0x1
 109:	e8 a2 03 00 00       	call   4b0 <printf>
    exit();
 10e:	e8 50 02 00 00       	call   363 <exit>
 ...
 418:	89 d1                	mov    %edx,%ecx
{
 ...
 44b:	0f b6 92 84 08 00 00 	movzbl 0x884(%edx),%edx
 ...
 4b9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 524:	ff 24 85 2c 08 00 00 	jmp    *0x82c(,%eax,4)
 ...
 650:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 655:	bb 23 08 00 00       	mov    $0x823,%ebx
